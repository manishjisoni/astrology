...
class Admin::ContactsControllerTest < ActionController::TestCase
  ...
  test "should create admin_contact" do
    assert_difference('Admin::Contact.count') do
      post :create, admin_contact: { email: @admin_contact.email, message: @admin_contact.message, name: @admin_contact.name, phone: @admin_contact.phone }
    end
  ...
  test "should update admin_contact" do
    patch :update, id: @admin_contact, admin_contact: { email: @admin_contact.email, message: @admin_contact.message, name: @admin_contact.name, phone: @admin_contact.phone }
    assert_redirected_to admin_contact_path(assigns(:admin_contact))
  end
